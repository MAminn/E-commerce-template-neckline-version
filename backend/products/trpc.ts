...
import {
  viewReviewsProcedure,
  viewAllReviewsProcedure,
  viewApprovedReviewsProcedure,
} from "./view-reviews/trpc";
import { updateReviewStatusProcedure } from "./update-review-status/trpc";
...
export const productRouter = t.router({
  ...
  getApprovedReviews: viewApprovedReviewsProcedure,
  updateReviewStatus: updateReviewStatusProcedure,
